...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 18, fontWeight: 'bold', color: '#F1F5F9', marginTop: 12 },
  cardSub: { fontSize: 14, color: '#94A3B8', textAlign: 'center', marginTop: 8, marginBottom: 20 },
