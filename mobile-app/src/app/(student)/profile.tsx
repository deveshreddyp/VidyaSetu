    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.roleBadge}>
          <Ionicons name="book-outline" size={13} color="#22D3EE" />
      ...
      <View style={styles.infoCard}>
        <View style={styles.infoRow}>
          <Ionicons name="mail-outline" size={18} color="#22D3EE" />
...
const styles = StyleSheet.create({
  ...
  initials: { fontSize: 28, fontWeight: '700', color: '#22D3EE' },
  ...
  roleText: { color: '#22D3EE', fontSize: 12, fontWeight: '600' },
